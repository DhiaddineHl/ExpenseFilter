...
const schema = z.object({
    description : z.string().min(3,{message : 'Discription should have at least 3 characters'} ).max(50),
    amount : z.number({ invalid_type_error : "Amount is required"}).min(0.1).max(1000),
